  ...
  'inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium transition-colors',
  {
    variants: {
      variant: {
        ...
        brand: 'bg-brand-500/15 text-brand-700 dark:text-brand-400 border border-brand-500/25 dark:border-brand-500/20',
        success: 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border border-emerald-500/25 dark:border-emerald-500/20',
        ...
        error: 'bg-red-500/15 text-red-700 dark:text-red-400 border border-red-500/25 dark:border-red-500/20',
      },
      size: {
